...
function LandingPage() {
  return (
    <>
      <div className=" homeContainer container bg-white shadow-2xl mx-auto  flex  flex-col justify-center text-center  sm:mt-20  ">
        <h1 className="inline-block mt-10 text-2xl font-sans sm:text-4xl ">
        ...
        <div className=" flex flex-col mx-auto  mt-10 mb-10 lg:flex-row lg:flex-wrap lg:justify-center">
          {' '}
