  ...
  return (
    <div className="group flex justify-between items-center ">
      ...
      <div className="flex justify-between items-center w-[90px]">
        {colorTheme === 'light' ? (
          <>
            <p className="dark:text-gLightLightGray text-gLightDarkBlue font-[900] tracking-widest group-hover:text-gLightDarkBlue transition duration-300">
              LIGHT
            </p>
            <svg
            ...
            >
              <g fill="#FFF" fillRule="nonzero">
                <path
                  ...
                  className="transition duration-300 group-hover:fill-gLightDarkBlue"
                />
              </g>
            </svg>
          </>
          ...
          <>
            <p className="dark:text-gLightLightGray text-gLightDarkBlue font-[900] tracking-widest group-hover:text-black transition duration-300">
              DARK
            </p>
            <svg
              onClick={() => setTheme(colorTheme)}
            ...
            >
              <path
                ...
                fill="#697C9A"
                fillRule="nonzero"
                className="transition duration-300 group-hover:fill-[#000]"
              />
            </svg>
          </>
        )}
